...
class BoardNotationTest {
    ...
    void getCoordinatesOfNotation() {
        assertEquals(new Coordinate(1, 0), BoardNotation.getCoordinatesOfNotation('b', 1));
        assertEquals(new Coordinate(7, 1), BoardNotation.getCoordinatesOfNotation('h', 2));
        assertEquals(new Coordinate(0, 2), BoardNotation.getCoordinatesOfNotation('a', 3));
        assertEquals(new Coordinate(2, 3), BoardNotation.getCoordinatesOfNotation('c', 4));
        assertEquals(new Coordinate(4, 4), BoardNotation.getCoordinatesOfNotation('e', 5));
        assertEquals(new Coordinate(5, 5), BoardNotation.getCoordinatesOfNotation('f', 6));
        assertEquals(new Coordinate(3, 6), BoardNotation.getCoordinatesOfNotation('d', 7));
        assertEquals(new Coordinate(6, 7), BoardNotation.getCoordinatesOfNotation('g', 8));
    }
